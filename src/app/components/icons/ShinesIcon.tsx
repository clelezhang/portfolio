...
export default function ShinesIcon({ className = "" }: ShinesIconProps) {
  return (
    ...
    >
      ...
      <defs>
        <filter id="a" width="21.689" height="15.638" x="9.586" y="0" colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse">
          <feFlood floodOpacity="0" result="BackgroundImageFix"/>
          <feBlend in="SourceGraphic" in2="BackgroundImageFix" result="shape"/>
          <feGaussianBlur result="effect1_foregroundBlur_372_39" stdDeviation="1"/>
        </filter>
        <filter id="b" width="12.241" height="9.448" x="14.309" y="2.863" colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse">
          <feFlood floodOpacity="0" result="BackgroundImageFix"/>
          <feBlend in="SourceGraphic" in2="BackgroundImageFix" result="shape"/>
          <feGaussianBlur result="effect1_foregroundBlur_372_39" stdDeviation=".5"/>
        </filter>
        <filter id="c" width="12.241" height="10.379" x="5" y="19.621" colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse">
          <feFlood floodOpacity="0" result="BackgroundImageFix"/>
          <feBlend in="SourceGraphic" in2="BackgroundImageFix" result="shape"/>
          <feGaussianBlur result="effect1_foregroundBlur_372_39" stdDeviation=".5"/>
        </filter>
