...
export function CommentCursor({ color }: CommentCursorProps) {
  return (
    <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ transform: 'translate(0px, 0px)' }}>
      <g filter="url(#filter0_d_commentcursor)">
        ...
        <path d="M12.5 1.75C17.8848 1.75 22.25 6.11522 22.25 11.5C22.25 16.8848 17.8848 21.25 12.5 21.25C7.11522 21.25 2.75 16.8848 2.75 11.5V3.5C2.75 2.5335 3.5335 1.75 4.5 1.75H12.5Z" stroke={color} strokeWidth="1.5"/>
      ...
      <defs>
        <filter id="filter0_d_commentcursor" x="0" y="0" width="25" height="25" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
