...
export function CommentCursor() {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M7 20.5C4.51472 20.5 2.5 18.4853 2.5 16V11C2.5 5.7533 6.7533 1.5 12 1.5C17.2467 1.5 21.5 5.7533 21.5 11C21.5 16.2467 17.2467 20.5 12 20.5H7Z" stroke="white" strokeWidth="1.5"/>
    </svg>
  );
}
